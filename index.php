...
if($row>0)
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,dob) values('$fname','$lname','$email','$enc_password','$contact','$dob')");
...
<div class="main">
		...
		<a style="position: relative;left: 47%; top: -25px" href="admin/index.php">Admin Login</a>
	 <div class="sap_tabs">	
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<p>DOB </p>
								<input class="date" type="date" value="" name="dob" required>
								<div class="sign-up">
	     ...
	     <a style="color: red; position: absolute; " href="admin/index.php">Admin Login</a>
</body>
</html>